...
clothing_types = ['saree', 'chudidhar', 'shrewani']
    ...
    try:
        ...
        if st.button('Find Similar Images'):
            ...
            if uploaded_image_features is not None:
                ...
                for i, img_file in enumerate(filtered_similar_images[:3]):
                    ...
                    with cols[i]:
                        st.image(resized_img, caption=f'Similar Image {i+1}', use_column_width=True)
